...
//            "ON ACCESS_TOKEN_TABLE.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE.TOKEN_ID";
    ...
    public static final String GET_ACCESS_TOKEN_DATA_BY_AUTHZUSER = "SELECT DISTINCT ACCESS_TOKEN, " +
            "IDN_OAUTH2_ACCESS_TOKEN.TOKEN_ID, TIME_CREATED, VALIDITY_PERIOD FROM IDN_OAUTH2_ACCESS_TOKEN JOIN " +
            "IDN_OAUTH2_ACCESS_TOKEN_SCOPE ON IDN_OAUTH2_ACCESS_TOKEN.TOKEN_ID=IDN_OAUTH2_ACCESS_TOKEN_SCOPE.TOKEN_ID " +
            "WHERE AUTHZ_USER=? AND IDN_OAUTH2_ACCESS_TOKEN.TENANT_ID=? AND TOKEN_STATE=? AND USER_DOMAIN=? AND " +
            "TOKEN_SCOPE=?";
