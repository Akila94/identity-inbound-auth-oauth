...
public class OAuthAdminServiceTest extends PowerMockIdentityBaseTest {
    ...
    public void testUpdateConsumerApplication(String loggedInUsername,
        ...
        OAuthAppDAO oAuthAppDAOMock = PowerMockito.mock(OAuthAppDAO.class);
        when(oAuthAppDAOMock.getAppInformation(consumerKey)).thenReturn(app);
        whenNew(OAuthAppDAO.class).withAnyArguments().thenReturn(oAuthAppDAOMock);
